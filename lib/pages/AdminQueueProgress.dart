                ...
                child: Column(
                  ...
                  children: [
                    ...
                    const Padding(
                      ...
                      child: Text("Being served", style: TextStyle(fontSize: 18)),
                    ),
                    //Being served
                    Container(
                        ...
                        child: Center(
                          child: SingleChildScrollView(
                            child: queue.users.isNotEmpty
                                ? Text(queue.users[0].name as String, style: const TextStyle(fontSize: 20))
                                : const Text("Queue empty", style: TextStyle(fontSize: 20)),
                          ),
                        )),
                    //Advance button
                    Padding(
