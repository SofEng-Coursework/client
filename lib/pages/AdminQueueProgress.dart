...
Future<List<String>> getPeopleInQueue(AdminQueueController adminQueueController, Queue queue) async{
...
class _AdminQueueProgressState extends State<AdminQueueProgress> {
  ...
  double screenHeight = WidgetsBinding.instance.platformDispatcher.views.first.physicalSize.height;
  int waitTime = 15;
    ...
    return Scaffold(
        ...
        body: StreamBuilder<Object>(
            ...
            builder: (context, snapshot) {
              ...
              List<String> peopleInQueue = getPeopleInQueue(adminQueueController, queue) as List<String>;
              ...
              return Row(mainAxisSize: MainAxisSize.min, children: [
                /*left side*/ Column(
                  ...
                  children: [
                    const Text("Queue", style: TextStyle(fontSize: 30, fontWeight: FontWeight.w900)),
                    /*queue*/ Container(
                                    ...
                                    trailing: isEditingQueue
                                        ? Row(mainAxisSize: MainAxisSize.min, children: [
                                            ElevatedButton(
                                              ...
                                              style: editStyle,
                                              child: const Text("\u25b2",
                                                  style: TextStyle(color: Color(0xFFFFFFFF), fontWeight: FontWeight.bold, fontSize: 10)),
                                            ),
                                            ElevatedButton(
                                              //move person down
                                              onPressed: () {
                    ...
                    /*edit button*/ ElevatedButton(
                      ...
                      style: ButtonStyle(
                          shape: MaterialStateProperty.all<RoundedRectangleBorder>(RoundedRectangleBorder(
                              borderRadius: BorderRadius.circular(10), side: const BorderSide(color: Color(0xFF600000), width: 3))),
                          backgroundColor: MaterialStateProperty.all<Color>(const Color(0xFFFF0101))),
                      child: const Text("Edit", style: TextStyle(color: Color(0xFFFFFFFF), fontSize: 15, fontWeight: FontWeight.bold)),
                    ),
                    if (isEditingQueue)
                      /*add person button*/ Container(
                          ...
                          child: ElevatedButton(
                              ...
                              style: ButtonStyle(
                                  shape: MaterialStateProperty.all<RoundedRectangleBorder>(RoundedRectangleBorder(
                                      borderRadius: BorderRadius.circular(10), side: const BorderSide(color: Color(0xFF01CA08), width: 3))),
                                  backgroundColor: MaterialStateProperty.all<Color>(const Color(0xFF017A08))),
                            ...
                            ElevatedButton(
                                  ...
                                  showDialog(
                                      ...
                                      builder: (BuildContext context) {
                                        return AlertDialog(
                                            ...
                                            content: Text("Would you like to add ${addToQueue.text} to the queue?"),
                                            actions: [
                                              ElevatedButton(
                                ...
                                style: ButtonStyle(
                                    shape: MaterialStateProperty.all<RoundedRectangleBorder>(RoundedRectangleBorder(
                                        ...
                                        side: const BorderSide(color: Color(0xFF600000), width: 3))),
                                    backgroundColor: MaterialStateProperty.all<Color>(const Color(0xFFFF0101))),
                                child: const Text("Confirm",
                                    style: TextStyle(color: Color(0xFFFFFFFF), fontSize: 15, fontWeight: FontWeight.bold)))
                          ]))
                ...
                /*wait time*/ Column(mainAxisSize: MainAxisSize.min, mainAxisAlignment: MainAxisAlignment.center, children: [
                  Container(
                      ...
                      child: Column(mainAxisSize: MainAxisSize.min, mainAxisAlignment: MainAxisAlignment.center, children: [
                        const Text("Current Wait Time:",
                            textAlign: TextAlign.center, style: TextStyle(fontSize: 20, color: Color(0xFFFFFFFF))),
